class RiderSelectScene extends Phaser.Scene{
  ...
  create(){
    ...
    this.add.text(32,126,'RIDERS (KEIRIN SKULL RIDERS)',{fontFamily:'monospace',fontSize:'16px',color:'#ff2b6d'});
    ...
    this.add.text(480,525,'← → SELECT     ENTER CONFIRM     ESC BACK',{fontFamily:'monospace',fontSize:'14px',color:'#f4eed7'}).setOrigin(.5);
  ...
  refresh(){
    ...
    const desc={ALLROUND:'Balanced and reliable.',STAYER:'Strong sustained pace.',ATTACKER:'Explosive and aggressive.',SPRINTER:'Saves energy for the finish.',ECONOMIST:'Flow and recovery specialist.',DEFENDER:'Excellent positioning.',WILDCARD:'Unpredictable and fast.'};
