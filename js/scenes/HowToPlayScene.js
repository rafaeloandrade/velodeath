class HowToPlayScene extends Phaser.Scene{
  ...
  create(){
    ...
    const body=['← →  ALTERNATE TO PEDAL','↑ ↓  CHANGE LINE DURING OPEN RACE','','FLOW ON = DRAFT + STAMINA RECOVERY','FLOW OFF = STAMINA DRAIN','ATTACK = LEAVE THE WHEEL AND PASS','','1 LAP WITH DEATH PACER','2 OPEN RACE LAPS','','PRESS ESC TO RETURN'].join('\n');
