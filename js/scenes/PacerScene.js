class PacerScene extends Phaser.Scene {
  ...
  resetGame(){
    ...
    this.pacerFinishProgress=this.nextFinishCrossing(this.pacerStartProgress);
  ...
  beginOpenRace(){
    ...
    this.time.delayedCall(1050,()=>{
      ...
      this.openRaceFinishProgress=this.openRaceFirstLine+(this.totalOpenLaps-1);
  ...
  updateOpenRace(dt){
    ...
    const lap=player.progress<this.openRaceFirstLine?1:2;
